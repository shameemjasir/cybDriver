  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          title: Text('${locale.order} - #${orderDetaials.cartId}',style: Theme.of(context)
              .textTheme
              .headline4
              .copyWith(fontWeight: FontWeight.w500,color: kMainTextColor,fontSize: 13)),
                ...
                children: [
                  ListTile(
                    ...
                    trailing: buildCircularButton(
                      ...
                      locale.direction,
                      type: 2,
                      url: 'https://maps.google.com/maps?daddr=${orderDetaials.userLat},${orderDetaials.userLng}'
                    ),
                  ),
                  Divider(
                    height: 5,
