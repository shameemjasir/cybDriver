    ...
    if(!enterFirst){
      setState(() {
        ...
        distance = calculateDistance(
            double.parse('${orderDetaials.userLat}'), double.parse('${orderDetaials.userLng}'), double.parse('${orderDetaials.storeLat}'), double.parse('${orderDetaials.storeLng}')).toStringAsFixed(2);
        time = calculateTime(
            double.parse('${orderDetaials.userLat}'), double.parse('${orderDetaials.userLng}'), double.parse('${orderDetaials.storeLat}'), double.parse('${orderDetaials.storeLng}'));
        print('${distance}');
        print('${time}');
      });
    }
          ...
          children: [
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    (order_details!=null && order_details.length>0)?ListView.separated(
                        shrinkWrap: true,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Text('${locale.paymentmode} \n${orderDetaials.paymentMethod}',style: Theme.of(context).textTheme.bodyText1.copyWith(fontSize: 16,color: Color (0xFF39c526), ) ),
                          Spacer(),
                          Text('${locale.invoice4h} ${locale.invoice3h} \n$apCurency ${orderDetaials.remainingPrice}',textAlign: TextAlign.center,style: Theme.of(context).textTheme.bodyText1.copyWith(fontSize: 16, color:Color (0xFF39c526),),)
                        ],
                      ),
                    ),
                    ...
                    ListTile(
                      ...
                      subtitle: Text('${orderDetaials.storeAddress}',style: Theme.of(context).textTheme.bodyText2.copyWith(fontSize: 12),),
                    ),
                    ListTile(
                      ...
                      subtitle: Text('${orderDetaials.userAddress}',style: Theme.of(context).textTheme.bodyText2.copyWith(fontSize: 12),),
                    ),
                    SizedBox(height:60),
                  ],
                ),
