    ...
    return WillPopScope(
      ...
      child: Scaffold(
        body: Column(
          children: [
            Spacer(flex: 2,),
            Image.asset('assets/delivery completed.png',scale: 3,),
            Spacer(),
              ...
              child: Row(
                children: [
                  RichText(text: TextSpan(children: <TextSpan>[
                    ...
                    TextSpan(text: locale.viewOrderInfo,style: Theme.of(context).textTheme.bodyText1.copyWith(fontSize: 17,color: Theme.of(context).primaryColor,height: 1.5, ),recognizer: TapGestureRecognizer()..onTap = (){
